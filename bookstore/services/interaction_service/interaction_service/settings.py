...
SECRET_KEY    = os.environ.get('SECRET_KEY', 'dev-key-interaction_service')
...
DATABASES = {
    'default': {
        ...
        'USER':     os.environ.get('DB_USER',     'interaction_user'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'interaction_pass_2024'),
        'HOST':     os.environ.get('DB_HOST',     'interaction_db'),
